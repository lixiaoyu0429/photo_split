...
def Images_without_Labels_Merge(folder_path, Have_Labels, n, m, overlap):
    ...
    for tag in group:
        # ****************
        hhh_path = os.path.abspath(os.path.join(os.getcwd(),'photo',tag+'.jpg'))
...
if __name__ == "__main__":
    ...
    # api(Image_with_Labels_Split, 'D:\learn\photo_split\photo', False, 3, 3, 0)
    api(Images_without_Labels_Merge, '230712_090353', False, 9, 7, 0)
